                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                <th scope="col">ポイント配布場所番号</th>
                                                <th scope="col">ポイント配布場所の名前</th>
                                                <th scope="col">ポイントのQRコード</th>
                                        ...
                                        <tbody>
                                            ...
                                            try {
                                                ...
                                                // SQL文をセット
                                                $stmt = $pdo->prepare('SELECT POINTFIELD_NO,POINTFIELD_NAME,POINTFIELD_QRCODE,UPLOAD_DATE FROM POINTPOSITION_MASTER WHERE 1');
                                                ...
                                                while (true) {
                                                    ...
                                                    print '<tr>';
                                                    print '<td>' . $rec['POINTFIELD_NO'] . '</td>';
                                                    print '<td>' . $rec['POINTFIELD_NAME'] . '</td>';
                                                    print '<td>' . $rec['POINTFIELD_QRCODE'] . '</td>';
                                                    print '<td>' . $rec['UPLOAD_DATE'] . '</td>';
                                                    print '<td>';
                                                    print '<input type="hidden" name="POINTFIELD_NO" value="' . $rec['POINTFIELD_NO'] . '"/>';
                                                    print '<input type="hidden" name="POINTFIELD_NAME" value="' . $rec['POINTFIELD_NAME'] . '"/>';
                                                    print '<input type="hidden" name="POINTFIELD_QRCODE" value="' . $rec['POINTFIELD_QRCODE'] . '"/>';
                                ...
                                <a href="top_point_set.php" class="btn btn-block btn-light">Add Master</a>
                            </div>
                        </div>
                    </div>
